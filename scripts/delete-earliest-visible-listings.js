 ...
 * Usage: node scripts/delete-earliest-visible-listings.js
 */
...
async function getEarliestVisibleListings() {
...
async function deleteEarliestVisibleListings() {
  try {
...
module.exports = { deleteEarliestVisibleListings };
